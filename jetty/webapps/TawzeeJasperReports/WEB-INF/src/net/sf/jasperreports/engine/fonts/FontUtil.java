...
public final class FontUtil
{
	...
	public FontInfo getFontInfo(String name, Locale locale)
	{
		...
		for (Iterator<FontFamily> itf = families.iterator(); itf.hasNext();)
		{
			...
			//log.info(" ======== FontFamily: " + family);
			//log.info(" ======== Locale: " + locale);
			//log.info(" ======== SupportsLocale: " + family.supportsLocale(locale));
			
			if (locale == null || family.supportsLocale(locale))
			{
				//log.info(" ======== family.getName(): " + family.getName());
				...
				//log.info(" ======== FontFace: " + face);
				//log.info(" ======== face.getName(): " + face.getName());
	...
	public Font getAwtFontFromBundles(String name, int style, float size, Locale locale, boolean ignoreMissingFont)
	{
		...
		if (fontInfo != null)
		{
			...
			log.info("Family: " + family + " Face: " + face);
...
//				}
			...
			//if (true)
			//	throw new JRRuntimeException("******** FontFace: " + face +  "GetFont: " + face.getFont() + " Family: " + family.getName() + " *********");
	...
	public void checkAwtFont(String name, boolean ignoreMissingFont)
	{
		...
		{
			//if (true)
			//	throw new JRFontNotFoundException("FFFFFFFFFFFFFFFFF");
	...
	public Font getAwtFont(JRFont font, Locale locale)
	{
		...
		log.info("FontName2: " + font.getFontName());
