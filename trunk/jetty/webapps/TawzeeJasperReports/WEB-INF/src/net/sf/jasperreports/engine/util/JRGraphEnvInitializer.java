	...
	public static synchronized void initializeGraphEnv()
	{
		if (AVAILABLE_FONT_FACE_NAMES == null)
		{
			...
			try
			{
				...
				//if (true)
				//	throw new JRRuntimeException(AVAILABLE_FONT_FACE_NAMES.toString());
...
/*		
		if (true) {
			if (AVAILABLE_FONT_FACE_NAMES.contains(font) == true)
				throw new JRRuntimeException("T: " + font);
			else
				throw new JRRuntimeException("F: " + font);
		}
*/		
