...
public final class JasperCompileManager
{
	...
	private JRCompiler getJavaCompiler()
	{
        ...
        //System.out.println("return compiler");
		return compiler;
	}
	...
	private JRCompiler getCompiler(JasperDesign jasperDesign) throws JRException
	{
		...
		//System.out.println("Content-Type: text/html\n\n");
        //System.out.println("compilerClassName: " + compilerClassName);
		...
		if (compilerClassName == null || compilerClassName.trim().length() == 0)
		{
	        ...
	        //System.out.println("compilerClassName2: " + compilerClassName);
		...
		try 
		{
	        ...
	        //System.out.println("compilerClassName3: " + compilerClassName);
			
			compiler = (JRCompiler)clazz.newInstance();

	        //System.out.println("compilerClassName4: " + compilerClassName);
