...
$config = array(
	...
	'mewSQLAuth' => array(
		'mewmodule:mewSQLAuth',

		'dsn' => 'mysql:host=tawzee.mew.gov.kw;dbname=tawzee',
		'username' => 'roman',
		'password' => 'mew@npX3ZNcu',
		//'dsn' => 'mysql:host=mysql.mew.gov.kw;dbname=tamdidat',
		//'username' => 'romains',
		//'password' => 'npX3ZNcu',
		//'username' => 'root',
		//'password' => '',
		//'dsn' => 'mysql:host=mysql.mew.gov.kw;dbname=tamdidat',
		//'username' => 'tam',
		//'password' => '3Xyx,Qr3:XwyxGdM',
		'query' => 'SELECT LoginName, UPN, DisplayName FROM UserRepository WHERE LoginName = :loginName',
	),

	'mewADAuth' => array(
		'mewmodule:mewADAuth',

		'ldap_dc' => 'dc1.mew.gov.kw',
		'ldap_username' => 'cn=adfetch adfetch,ou=Service Accounts,ou=Service Management,dc=mew,dc=gov,dc=kw',
		'ldap_password' => 'P@ssw0rd@MEW',
		'ldap_base_dn' => 'OU=MEW,DC=mew,DC=gov,DC=kw',
	),

	'mewSQLStatic' => array(
		'mewmodule:mewSQLStatic',
		'dsn' => 'mysql:host=;dbname=tamdidat',
		'username' => 'root',
		'password' => '',
		'query' => 'SELECT loginName, upn, displayName FROM userRepository WHERE loginName = :loginName',
/*
		'LoginName' => array('roman'),
		'password' => array('roman'),
		'DisplayName' => array('Roman D.'),
		'UserPrincipalName' => array('roman@mewj.gov.kw'),
*/		
	),
	...
	*/
	...
	'example-userpass' => array(
		...
		'manager:man123' => array(
			'uid' => array('manager'),
			'eduPersonAffiliation' => array('member', 'manager'),
		),
		'employee:emp123' => array(
			'uid' => array('employee'),
			'eduPersonAffiliation' => array('member', 'employee'),
		),
	),
