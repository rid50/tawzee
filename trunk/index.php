...
<div id="main-form" class="forms" style="display:none; padding:20px; font-size:1.2em" class="floatLeft"
	data-link="application-form-link" data-parent-table="Application" data-child-table="ApplicationDetail" data-key-field="application-number">
		<div>
			...
			<input type="text" id="application-number" autofocus maxlength="24" class="text ui-widget-content ui-corner-all" data-is-required="false"/>
			<label for="application-date">Application Date</label>
			<input type="text" id="application-date" maxlength="10" class="rid50-datepicker text ui-widget-content ui-corner-all" data-is-required="false"/><br/>
			...
			<select id="controlCenterId" class="ui-widget-content ui-corner-all" style="width:150px" data-validation='^([1-9])', data-validation-message="$.i18n.prop('ControlCenter') + ' ' + $.i18n.prop('CannotBeEmpty')"></select><br/>
